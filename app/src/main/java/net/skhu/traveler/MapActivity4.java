...
import net.skhu.traveler.adapter.LocationAdapter;
import net.skhu.traveler.ApiClient;
import net.skhu.traveler.ApiInterface;
import net.skhu.traveler.model.Document;
import net.skhu.traveler.model.CategoryResult;
import net.skhu.traveler.utils.BusProvider;
import net.skhu.traveler.utils.IntentKey;
...
public class MapActivity4 extends AppCompatActivity implements MapView.MapViewEventListener, MapView.POIItemEventListener, MapView.OpenAPIKeyAuthenticationResultListener, View.OnClickListener, MapView.CurrentLocationEventListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.fab_detail:
                ...
                Intent detailIntent = new Intent(MapActivity4.this, MapSearchDetailActivity.class);
                ...
                if (index == 0) {
                    ...
                    call.enqueue(new Callback<CategoryResult>() {
                        ...
                        public void onResponse(@NotNull Call<CategoryResult> call, @NotNull Response<CategoryResult> response) {
                            mLoaderLayout.setVisibility(View.GONE);
                            if (response.isSuccessful()) {
                                Intent intent = new Intent(MapActivity4.this, PlaceDetailActivity.class);
                                assert response.body() != null;
