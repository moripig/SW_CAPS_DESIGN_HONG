//사용 X -> ScedulePopup으로 새로운 글 작성, 수정 대처하였음.
...
//        newschedule_place = (EditText)findViewById(R.id.newschedule_place);
//
...
//                        0,
//                        newschedule_place.getText().toString(),
...
//                });
//
//                startActivity(new Intent(ScheduleCreateActivity.this, CalendarActivity.class));
//            }
//        });
//    }
//}